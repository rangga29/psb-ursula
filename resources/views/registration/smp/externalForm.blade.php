        ...
        <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body main-content">
                    ...
                    @endif
                    <form action="{{ route('smp.registration.externalStore') }}" method="POST" class="forms-sample" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-8 col-xxl-10">
                                <select class="form-select js-select" name="register_grade" id="register_grade" data-width="100%">
                                    <option value="7" {{ old('register_grade') == '7' ? 'selected' : '' }}>Kelas 7</option>
                                    <option value="8" {{ old('register_grade') == '8' ? 'selected' : '' }}>Kelas 8</option>
                                    <option value="9" {{ old('register_grade') == '9' ? 'selected' : '' }}>Kelas 9</option>
                                </select>
                            </div>
                        </div>
                        <hr class="mb-4">
