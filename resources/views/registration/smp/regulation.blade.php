                ...
                <div class="card">
                    <div class="card-body main-content text-center">
                        @if ($page_setting['path'] == 'Internal')
                            ...
                            <p class="mb-4">
                                <span class="fw-bolder">Jalur Internal</span> dikhususkan untuk calon siswa yang berasal dari SD Santa Ursula Bandung.
                            </p>
                            <hr>
                        @else
                            <h4 id="changing-seperator" class="fw-bolder">-- 1 --</h4>
                            <p class="mb-4">
                                <span class="fw-bolder">Jalur External</span> dikhususkan untuk calon siswa yang tidak berasal dari SD Santa Ursula Bandung atau ketika PSB Jalur Internal tidak dibuka.
                            </p>
                            <hr>
                        @endif
                        ...
                        <p class="mb-4">
                            Jika terdapat kesulitan atau pertanyaan silahkan hubungi kami melalui telepon <a href="tel:0227274584">(022) 727 4584</a> atau <a href="tel:081220152429">0812 2015 2429</a>.
                        </p>
                        <hr class="mt-2 mb-2">
                        <div class="d-grid gap2">
                            @if ($page_setting['path'] == 'Internal')
                                <a href="{{ route('smp.registration.internalForm') }}" class="btn btn-primary me-2 fw-bolder">SUBMIT</a>
                            @else
                                <a href="{{ route('smp.registration.externalForm') }}" class="btn btn-primary me-2 fw-bolder">SUBMIT</a>
                            @endif
                        </div>
                    </div>
                </div>
