        ...
        <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body main-content">
                    ...
                    @endif
                    <form action="{{ route('sd.registration.internalStore') }}" method="POST" class="forms-sample" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-8 col-xxl-10">
                                <input type="text" class="form-control @error('origin_school') is-invalid @enderror" name="origin_school" id="origin_school" placeholder="Asal Sekolah"
                                    value="TK Santa Ursula Bandung" readonly>
                                @error('origin_school')
                                    <small class="text-danger">* {{ $message }}</small>
                                @enderror
                            </div>
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-8 col-xxl-10">
                                <select class="form-select js-select" name="register_grade" id="register_grade" data-width="100%">
                                    ...
                                    <option value="2" disabled>Kelas 2</option>
                                    <option value="3" disabled>Kelas 3</option>
                                    <option value="4" disabled>Kelas 4</option>
                                    <option value="5" disabled>Kelas 5</option>
                                    <option value="6" disabled>Kelas 6</option>
                                </select>
                            </div>
                        </div>
                        <hr class="mb-4">
