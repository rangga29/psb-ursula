...
@section('content')
    <div class="d-flex justify-content-between align-items-center grid-margin flex-wrap">
        <div>
            <h1 class="page-title fw-bolder text-uppercase">Formulir Pendaftaran</h1>
        ...
        <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body main-content">
                    ...
                    @endif
                    <form action="{{ route('tbtk.registration.store') }}" method="POST" class="forms-sample" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-8 col-xxl-10">
                                <select class="form-select js-select" name="register_grade" id="register_grade" data-width="100%">
                                    <option value="1" {{ old('register_grade') == '1' ? 'selected' : '' }}>Kelas TB</option>
                                    <option value="2" {{ old('register_grade') == '2' ? 'selected' : '' }}>Kelas TK A</option>
                                    <option value="3" {{ old('register_grade') == '3' ? 'selected' : '' }}>Kelas TK B</option>
                                </select>
                            </div>
                        </div>
                        <hr class="mb-4">
