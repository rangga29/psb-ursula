...
@section('content')
    ...
    <div class="d-flex justify-content-between align-items-center grid-margin flex-wrap">
        <div>
            <h3 class="mb-md-0 fw-bolder text-uppercase mb-3">#4 - Data Ibu</h3>
        </div>
    </div>
        ...
        <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    @endif
                    <form action="{{ route('dashboard.' . $page_setting['unit_slug'] . '.student.dapodik.ibu.store') }}" method="POST" class="forms-sample">
                        @csrf
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-8 col-xxl-10">
                                <select class="form-select js-select" name="ibu_agama" id="ibu_agama" data-width="100%">
                                    ...
                                    <option value="Kristen Protestan" {{ old('ibu_agama') == 'Kristen Protestan' ? 'selected' : '' }}>Kristen Protestan</option>
                                    <option value="Islam" {{ old('ibu_agama') == 'Islam' ? 'selected' : '' }}>Islam</option>
                                    <option value="Hindu" {{ old('ibu_agama') == 'Hindu' ? 'selected' : '' }}>Hindu</option>
                                    <option value="Budha" {{ old('ibu_agama') == 'Budha' ? 'selected' : '' }}>Budha</option>
                                    <option value="Kong Hu Cu" {{ old('ibu_agama') == 'Kong Hu Cu' ? 'selected' : '' }}>Kong Hu Cu</option>
                                    <option value="Kepercayaan Kepada Tuhan YME" {{ old('ibu_agama') == 'Kepercayaan Kepada Tuhan YME' ? 'selected' : '' }}>Kepercayaan Kepada Tuhan YME</option>
                                </select>
                            </div>
                        </div>
                        <div class="row mb-4">
                            ...
                            <div class="col-md-8 col-xxl-10">
                                <select class="form-select js-select" name="ibu_kewarganegaraan" id="ibu_kewarganegaraan" data-width="100%">
                                    <option value="WNI" {{ old('ibu_kewarganegaraan') == 'WNI' ? 'selected' : '' }}>Warga Negara Indonesia</option>
                                    <option value="WNA" {{ old('ibu_kewarganegaraan') == 'WNA' ? 'selected' : '' }}>Warga Negara Asing</option>
                                </select>
                            </div>
                        </div>
                        <div class="row mb-4">
                            ...
                            <div class="col-md-8 col-xxl-10">
                                <select class="form-select js-select" name="ibu_pendidikan" id="ibu_pendidikan" data-width="100%">
                                    ...
                                    <option value="Diploma 1" {{ old('ibu_pendidikan') == 'Diploma 1' ? 'selected' : '' }}>Diploma 1</option>
                                    <option value="Diploma 2" {{ old('ibu_pendidikan') == 'Diploma 2' ? 'selected' : '' }}>Diploma 2</option>
                                    <option value="Diploma 3" {{ old('ibu_pendidikan') == 'Diploma 3' ? 'selected' : '' }}>Diploma 3</option>
                                    <option value="Diploma 4" {{ old('ibu_pendidikan') == 'Diploma 4' ? 'selected' : '' }}>Diploma 4</option>
                                    <option value="Sarjana 1" {{ old('ibu_pendidikan') == 'Sarjana 1' ? 'selected' : '' }}>Sarjana 1</option>
                                    <option value="Sarjana 2" {{ old('ibu_pendidikan') == 'Sarjana 2' ? 'selected' : '' }}>Sarjana 2</option>
                                    <option value="Sarjana 3" {{ old('ibu_pendidikan') == 'Sarjana 3' ? 'selected' : '' }}>Sarjana 3</option>
                                    <option value="Lainnya" {{ old('ibu_pendidikan') == 'Lainnya' ? 'selected' : '' }}>Lainnya</option>
                                </select>
                            </div>
                        </div>
                        <div class="row mb-4">
                            ...
                            <div class="col-md-8 col-xxl-10">
                                <select class="form-select js-select" name="ibu_pekerjaan" id="ibu_pekerjaan" data-width="100%">
                                    <option value="Tidak Bekerja" {{ old('ibu_pekerjaan') == 'Tidak Bekerja' ? 'selected' : '' }}>Tidak Bekerja</option>
                                    <option value="PNS/TNI/Polri" {{ old('ibu_pekerjaan') == 'PNS/TNI/Polri' ? 'selected' : '' }}>PNS/TNI/Polri</option>
                                    <option value="Karyawan Swasta" {{ old('ibu_pekerjaan') == 'Karyawan Swasta' ? 'selected' : '' }}>Karyawan Swasta</option>
                                    <option value="Pedagang Kecil" {{ old('ibu_pekerjaan') == 'Pedagang Kecil' ? 'selected' : '' }}>Pedagang Kecil</option>
                                    <option value="Pedagang Besar" {{ old('ibu_pekerjaan') == 'Pedagang Besar' ? 'selected' : '' }}>Pedagang Besar</option>
                                    <option value="Wiraswasta" {{ old('ibu_pekerjaan') == 'Wiraswasta' ? 'selected' : '' }}>Wiraswasta</option>
                                    <option value="Wirausaha" {{ old('ibu_pekerjaan') == 'Wirausaha' ? 'selected' : '' }}>Wirausaha</option>
                                    <option value="Buruh" {{ old('ibu_pekerjaan') == 'Buruh' ? 'selected' : '' }}>Buruh</option>
                                    <option value="Pensiunan" {{ old('ibu_pekerjaan') == 'Pensiunan' ? 'selected' : '' }}>Pensiunan</option>
                                    <option value="Sudah Meninggal" {{ old('ibu_pekerjaan') == 'Sudah Meninggal' ? 'selected' : '' }}>Sudah Meninggal</option>
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-8 col-xxl-10">
                                <select class="form-select js-select" name="ibu_pendapatan" id="ibu_pendapatan" data-width="100%">
                                    <option value="gol1" {{ old('ibu_pendapatan') == 'gol1' ? 'selected' : '' }}>Tidak Berpenghasilan</option>
                                    <option value="gol2" {{ old('ibu_pendapatan') == 'gol2' ? 'selected' : '' }}>Kurang dari Rp 2.000.000</option>
                                    <option value="gol3" {{ old('ibu_pendapatan') == 'gol3' ? 'selected' : '' }}>Rp 2.000.000 - 5.000.000</option>
                                    <option value="gol4" {{ old('ibu_pendapatan') == 'gol4' ? 'selected' : '' }}>Rp 5.000.000 - 10.000.000</option>
                                    <option value="gol5" {{ old('ibu_pendapatan') == 'gol5' ? 'selected' : '' }}>Lebih Dari Rp 10.000.000</option>
                                </select>
                            </div>
                        </div>
                        <div class="row mb-4">
                            ...
                            <div class="col-md-8 col-xxl-10">
                                <input type="text" class="form-control @error('ibu_nama_perusahaan') is-invalid @enderror" name="ibu_nama_perusahaan" id="ibu_nama_perusahaan"
                                    placeholder="Nama Perusahaan" value="{{ old('ibu_nama_perusahaan') }}">
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-8 col-xxl-10">
                                <input type="text" class="form-control @error('ibu_alamat_perusahaan') is-invalid @enderror" name="ibu_alamat_perusahaan" id="ibu_alamat_perusahaan"
                                    placeholder="Alamat Perusahaan" value="{{ old('ibu_alamat_perusahaan') }}">
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-8 col-xxl-10">
                                <select class="form-select js-select" name="ibu_kebutuhan_khusus" id="ibu_kebutuhan_khusus" data-width="100%">
                                    <option value="Ya" {{ old('ibu_kebutuhan_khusus') == 'Ya' ? 'selected' : '' }}>Ya</option>
                                    <option value="Tidak" {{ old('ibu_kebutuhan_khusus') == 'Tidak' ? 'selected' : 'selected' }}>Tidak</option>
                                </select>
                            </div>
                        </div>
                        <div class="row mb-4">
                            ...
                            <div class="col-md-8 col-xxl-10">
                                <input type="text" class="form-control @error('ibu_jenis_kebutuhan_khusus') is-invalid @enderror" name="ibu_jenis_kebutuhan_khusus" id="ibu_jenis_kebutuhan_khusus"
                                    placeholder="Jenis Kebutuhan Khusus" value="{{ old('ibu_jenis_kebutuhan_khusus') }}">
