...
@section('content')
    ...
    <div class="d-flex justify-content-between align-items-center grid-margin flex-wrap">
        <div>
            <h3 class="mb-md-0 fw-bolder text-uppercase mb-3">#2 - Data Kependudukan</h3>
        </div>
    </div>
        ...
        <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('dashboard.' . $page_setting['unit_slug'] . '.student.dapodik.kependudukan.store') }}" method="POST" class="forms-sample" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-8 col-xxl-10">
                                <input type="number" class="form-control @error('nkk') is-invalid @enderror" name="nkk" id="nkk" placeholder="Nomor Kartu Keluarga" value="{{ old('nkk') }}">
                                @error('nkk')
                                    <small class="text-danger">* {{ $message }}</small>
                                @enderror
                            </div>
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-8 col-xxl-10">
                                <input type="text" class="form-control @error('nak') is-invalid @enderror" name="nak" id="nak" placeholder="Nomor Akta Kelahiran" value="{{ old('nak') }}">
                                @error('nak')
                                    <small class="text-danger">* {{ $message }}</small>
                                @enderror
                            </div>
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-8 col-xxl-10">
                                ...
                                <small>* Pas Foto Dari Kepala Sampai Dada / Perut</small>
                                @error('pas_foto')
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-8 col-xxl-10">
                                <input type="number" class="form-control @error('kk_rt') is-invalid @enderror" name="kk_rt" id="kk_rt" placeholder="[KK] RT" value="{{ old('kk_rt') }}">
                                @error('kk_rt')
                                    <small class="text-danger">* {{ $message }}</small>
                                @enderror
                            </div>
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-8 col-xxl-10">
                                <input type="number" class="form-control @error('kk_rw') is-invalid @enderror" name="kk_rw" id="kk_rw" placeholder="[KK] RW" value="{{ old('kk_rw') }}">
                                @error('kk_rw')
                                    <small class="text-danger">* {{ $message }}</small>
                                @enderror
                            </div>
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-8 col-xxl-10">
                                <select class="form-select js-select" name="transportasi" id="transportasi" data-width="100%">
                                    ...
                                    <option value="Kendaraan Umum" {{ old('transportasi') == 'Kendaraan Umum' ? 'selected' : '' }}>Kendaraan Umum</option>
                                    <option value="Jalan Kaki" {{ old('transportasi') == 'Jalan Kaki' ? 'selected' : '' }}>Jalan Kaki</option>
                                    <option value="Jemputan Sekolah" {{ old('transportasi') == 'Jemputan Sekolah' ? 'selected' : '' }}>Jemputan Sekolah</option>
                                    <option value="Transportasi Online" {{ old('transportasi') == 'Transportasi Online' ? 'selected' : '' }}>Transportasi Online</option>
