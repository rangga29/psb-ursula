...
@section('content')
    ...
    <div class="d-flex justify-content-between align-items-center grid-margin flex-wrap">
        <div>
            <h3 class="mb-md-0 fw-bolder mb-3">UBAH DATA</h3>
        </div>
    </div>
    <div class="row">
        <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('dashboard.general.year.update', $year->id) }}" method="POST" class="forms-sample">
                        @method('PUT')
                        @csrf
                        <div class="row mb-4">
                            ...
                            <div class="col-md-8 col-xxl-10">
                                <input type="number" class="form-control @error('code') is-invalid @enderror" name="code" id="code" placeholder="Kode Tahun"
                                    value="{{ old('code', $year->code) }}">
                                @error('code')
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-8 col-xxl-10">
                                <input type="text" class="form-control @error('name') is-invalid @enderror" name="name" id="name" placeholder="Nama Tahun"
