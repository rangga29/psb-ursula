...
@section('content')
    <nav class="page-breadcrumb">
        <ol class="breadcrumb">
            <li class="breadcrumb-item">TBTK Admin Management</li>
    ...
    <div class="d-flex justify-content-between align-items-center grid-margin flex-wrap">
        <div>
            <h3 class="mb-md-0 fw-bolder text-uppercase mb-3">{{ $tbtk_registration->full_name }} {{ $page_setting['grade'] != 'TBTK' ? '[Jalur ' . $tbtk_registration->registration_path . ']' : '' }}</h3>
        </div>
    </div>
        ...
        <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body main-content">
                    <form action="{{ route('dashboard.tbtk.admin.registration.update', $tbtk_registration->unique_code) }}" method="POST" class="forms-sample" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-8 col-xxl-10">
                                <input type="number" class="form-control" name="registration_code" value="{{ $tbtk_registration->registration_code }}" readonly>
                            </div>
                        </div>
                        <div class="row mb-4">
                            <label for="virtual_code" class="col-md-4 col-xxl-2 col-form-label fw-bolder text-uppercase">Kode Virtual</label>
                            <div class="col-md-8 col-xxl-10">
                                <input type="number" class="form-control" name="virtual_code" value="{{ $tbtk_registration->virtual_code }}" readonly>
                            </div>
                        </div>
                        <div class="row mb-4">
                            ...
                            <div class="col-md-8 col-xxl-10">
                                <input type="text" class="form-control @error('full_name') is-invalid @enderror" name="full_name" id="full_name" placeholder="Nama Lengkap"
                                    value="{{ old('full_name', $tbtk_registration->full_name) }}">
                                @error('full_name')
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-8 col-xxl-10">
                                <input type="text" class="form-control @error('nick_name') is-invalid @enderror" name="nick_name" id="nick_name" placeholder="Nama Panggilan"
                                    value="{{ old('nick_name', $tbtk_registration->nick_name) }}">
                                @error('nick_name')
                                    <small class="text-danger">* {{ $message }}</small>
                                @enderror
                            </div>
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-8 col-xxl-10">
                                <input type="text" class="form-control @error('birth_town') is-invalid @enderror" name="birth_town" id="birth_town" placeholder="Kota Kelahiran"
                                    value="{{ old('birth_town', $tbtk_registration->birth_town) }}">
                                @error('birth_town')
                                    <small class="text-danger">* {{ $message }}</small>
                                @enderror
                            </div>
                        ...
                        <div class="row mb-4">
                            <input type="hidden" name="oldBirthDate" value="{{ $tbtk_registration->birth_date }}">
                            ...
                            <div class="col-md-8 col-xxl-10">
                                <div class="input-group date datepicker" id="datePicker">
                                    <input type="text" class="form-control @error('birth_date') is-invalid @enderror" name="birth_date" id="birth_date" placeholder="Tanggal Lahir"
                                        value="{{ old('birth_date', \Carbon\Carbon::createFromFormat('Y-m-d', $tbtk_registration->birth_date)->format('d/m/Y')) }}">
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-8 col-xxl-10">
                                <input type="text" class="form-control @error('origin_school') is-invalid @enderror" name="origin_school" id="origin_school" placeholder="Asal Sekolah"
                                    value="{{ old('origin_school', $tbtk_registration->origin_school) }}">
                                @error('origin_school')
                                    <small class="text-danger">* {{ $message }}</small>
                                @enderror
                            </div>
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-8 col-xxl-10">
                                <select class="form-select js-select" name="gender" id="gender" data-width="100%" rea>
                                    <option value="Laki-Laki" {{ old('gender', $tbtk_registration->gender) == 'Laki-Laki' ? 'selected' : '' }}>Laki-Laki</option>
                                    <option value="Perempuan" {{ old('gender', $tbtk_registration->gender) == 'Perempuan' ? 'selected' : '' }}>Perempuan</option>
                                </select>
                            </div>
                        </div>
                        <div class="row mb-4">
                            ...
                            <div class="col-md-8 col-xxl-10">
                                <select class="form-select js-select" name="register_year" id="register_year" data-width="100%" disabled>
                                    @foreach ($page_setting['years'] as $year)
                                        @if (old('register_year', $tbtk_registration->register_year) == $year->id)
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-8 col-xxl-10">
                                <select class="form-select js-select" name="register_grade" id="register_grade" data-width="100%" disabled>
                                    <option value="1" {{ old('register_grade', $tbtk_registration->register_grade) == '1' ? 'selected' : '' }}>Kelas TB</option>
                                    <option value="2" {{ old('register_grade', $tbtk_registration->register_grade) == '2' ? 'selected' : '' }}>Kelas TK A</option>
                                    <option value="3" {{ old('register_grade', $tbtk_registration->register_grade) == '3' ? 'selected' : '' }}>Kelas TK B</option>
                                </select>
                            </div>
                        </div>
                        <hr class="mb-4">
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-8 col-xxl-10">
                                <input type="text" class="form-control @error('parent_name') is-invalid @enderror" name="parent_name" id="parent_name" placeholder="Nama Orang Tua"
                                    value="{{ old('parent_name', $tbtk_registration->parent_name) }}">
                                @error('parent_name')
                                    <small class="text-danger">* {{ $message }}</small>
                                @enderror
                            </div>
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-8 col-xxl-10">
                                <input type="number" class="form-control @error('parent_phone') is-invalid @enderror" name="parent_phone" id="parent_phone" placeholder="No. Handphone"
                                    value="{{ old('parent_phone', $tbtk_registration->parent_phone) }}">
                                @error('parent_phone')
                                    <small class="text-danger">* {{ $message }}</small>
                                @enderror
                            </div>
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-8 col-xxl-10">
                                <input type="email" class="form-control @error('parent_email') is-invalid @enderror" name="parent_email" id="parent_email" placeholder="Alamat Email"
                                    value="{{ old('parent_email', $tbtk_registration->parent_email) }}">
                                @error('parent_email')
                                    <small class="text-danger">* {{ $message }}</small>
                                @enderror
                            </div>
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-xxl-3">
                                <input type="hidden" name="oldPaymentProof" value="{{ $tbtk_registration->payment_proof }}">
                                <img src="{{ asset('upload/payment_proof/tbtk/' . $tbtk_registration->payment_proof) }}" class="card-img-top w-100" style="border-radius: 0px; background-color: black;"
