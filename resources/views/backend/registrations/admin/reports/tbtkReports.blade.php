                        ...
                        <div class="tab-pane fade show active" id="alldata" role="tabpanel" aria-labelledby="alldata-line-tab">
                            ...
                            <div class="tab-content mt-3" id="lineTabContent">
                                <div class="tab-pane fade show active" id="allexcel" role="tabpanel" aria-labelledby="allexcel-line-tab">
                                    <form action="{{ route('dashboard.tbtk.admin.registration.reports.all-excel') }}" method="POST" class="forms-sample">
                                        @csrf
                                        <div class="row mb-3">
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-10">
                                                <select class="js-filter form-select" name="all_excel_grade" id="all_excel_grade" data-width="100%">
                                                    ...
                                                    <option value="1">Kelas TB</option>
                                                    <option value="2">Kelas TK A</option>
                                                    <option value="3">Kelas TK B</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="row mb-3">
                                ...
                                <div class="tab-pane fade" id="allpdf" role="tabpanel" aria-labelledby="allpdf-line-tab">
                                    <form action="{{ route('dashboard.tbtk.admin.registration.reports.all-pdf') }}" method="POST" class="forms-sample">
                                        @csrf
                                        <div class="row mb-3">
                        ...
                        <div class="tab-pane fade" id="separatedata" role="tabpanel" aria-labelledby="separatedata-line-tab">
                            ...
                            <div class="tab-content mt-3" id="lineTabContent">
                                <div class="tab-pane fade show active" id="separateexcel" role="tabpanel" aria-labelledby="separateexcel-line-tab">
                                    <form action="{{ route('dashboard.tbtk.admin.registration.reports.separate-excel') }}" method="POST" class="forms-sample">
                                        @csrf
                                        <div class="row mb-3">
                                ...
                                <div class="tab-pane fade" id="separatepdf" role="tabpanel" aria-labelledby="separatepdf-line-tab">
                                    <form action="{{ route('dashboard.tbtk.admin.registration.reports.separate-pdf') }}" method="POST" class="forms-sample">
                                        @csrf
                                        <div class="row mb-3">
