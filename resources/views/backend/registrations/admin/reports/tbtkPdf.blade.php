...
<body>
    ...
    <div class="header">
        <center>
            <h1>PENERIMAAN SISWA BARU TBTK SANTA URSULA BANDUNG</h1>
            <h5>{{ $title }}</h5>
            @if ($year_name == '')
                @if ($grade_name == '')
                    <h2>Filter : {{ $filter }}</h2>
        ...
        <table>
            <thead>
                <tr>
                    ...
                    {!! $selection_status == '1' ? '<th>Status Observasi</th>' : '' !!}
            ...
            <tbody>
                @foreach ($registration_data as $registration)
                    <tr>
                        ...
                        {!! $register_grade == '1' ? '<td>' . ($registration->register_grade == '1' ? 'Kelas TB' : ($registration->register_grade == '2' ? 'Kelas TK A' : 'Kelas TK B')) . '</td>' : '' !!}
