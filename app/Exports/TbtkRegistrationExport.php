...
class TbtkRegistrationExport implements FromView, ShouldAutoSize, WithStyles, WithStrictNullComparison
{
    ...
    {
        return view('backend.registrations.admin.reports.tbtkExcel', [
