...
class SmpRegistrationExport implements FromView, ShouldAutoSize, WithStyles, WithStrictNullComparison
{
    ...
    protected $kelas4_sem1_indo;
    protected $kelas4_sem1_mat;
    protected $kelas4_sem2_indo;
    protected $kelas4_sem2_mat;
    protected $kelas5_sem1_indo;
    protected $kelas5_sem1_mat;
    protected $kelas5_sem2_indo;
    protected $kelas5_sem2_mat;
    ...
    function __construct($registration_data, $registration_code, $virtual_code, $registration_path, $full_name, $nick_name, $birth_town, $birth_date, $origin_school, $gender, $register_year, $register_grade, $parent_name, $parent_phone, $parent_email, $registration_date, $kelas4_sem1_indo, $kelas4_sem1_mat, $kelas4_sem2_indo, $kelas4_sem2_mat, $kelas5_sem1_indo, $kelas5_sem1_mat, $kelas5_sem2_indo, $kelas5_sem2_mat, $registration_status, $selection_status, $approval_status, $dapodik_status, $aggrement_status, $payment_status, $uniform_status, $book_status)
    {
        ...
        $this->kelas4_sem1_indo = $kelas4_sem1_indo;
        $this->kelas4_sem1_mat = $kelas4_sem1_mat;
        $this->kelas4_sem2_indo = $kelas4_sem2_indo;
        $this->kelas4_sem2_mat = $kelas4_sem2_mat;
        $this->kelas5_sem1_indo = $kelas5_sem1_indo;
        $this->kelas5_sem1_mat = $kelas5_sem1_mat;
        $this->kelas5_sem2_indo = $kelas5_sem2_indo;
        $this->kelas5_sem2_mat = $kelas5_sem2_mat;
    ...
    {
        return view('backend.registrations.admin.reports.smpExcel', [
            ...
            'kelas4_sem1_indo' => $this->kelas4_sem1_indo,
            'kelas4_sem1_mat' => $this->kelas4_sem1_mat,
            'kelas4_sem2_indo' => $this->kelas4_sem2_indo,
            'kelas4_sem2_mat' => $this->kelas4_sem2_mat,
            'kelas5_sem1_indo' => $this->kelas5_sem1_indo,
            'kelas5_sem1_mat' => $this->kelas5_sem1_mat,
            'kelas5_sem2_indo' => $this->kelas5_sem2_indo,
            'kelas5_sem2_mat' => $this->kelas5_sem2_mat,
