...
class SmpStudentController extends Controller
{
    function __construct()
    {
        $this->middleware('permission:smp-student-pendaftaran|smp-student-siswa|smp-student-administrasi|smp-student-pembelajaran');
    }
    ...
    public function dapodikPribadi()
    {
        ...
        if ($dapodik_pribadi != null) {
            return redirect()->route('dashboard.smp.student.dapodik.index')->with('error', 'Data Siswa - Data Pribadi Sudah Diisi');
        }
    ...
    public function dapodikPribadiStore(DapodikPribadiRequest $request)
    {
        ...
        if ($dapodik_pribadi != null && $dapodik_kependudukan != null && ($dapodik_ayah != null || $dapodik_ibu != null || $dapodik_wali != null)) {
            SmpRegistration::where('user_id', Auth::user()->id)->update(['dapodik_status' => 1]);
        }

        return redirect()->route('dashboard.smp.student.dapodik.index')->with('success', 'Data Siswa - Data Pribadi Berhasil Ditambah');
    }
    ...
    public function dapodikKependudukan()
    {
        ...
        if ($dapodik_kependudukan != null) {
            return redirect()->route('dashboard.smp.student.dapodik.index')->with('error', 'Data Siswa - Data Kependudukan Sudah Diisi');
        }
    ...
    public function dapodikKependudukanStore(StoreDapodikKependudukanRequest $request)
    {
        ...
        return redirect()->route('dashboard.smp.student.dapodik.index')->with('success', 'Data Siswa - Data Kependudukan Berhasil Ditambah');
    }
    ...
    public function dapodikAyah()
    {
        ...
        if ($dapodik_ayah != null) {
            return redirect()->route('dashboard.smp.student.dapodik.index')->with('error', 'Data Siswa - Data Ayah Sudah Diisi');
        }
    ...
    public function dapodikAyahStore(DapodikAyahRequest $request)
    {
        ...
        return redirect()->route('dashboard.smp.student.dapodik.index')->with('success', 'Data Siswa - Data Ayah Berhasil Ditambah');
    }
    ...
    public function dapodikIbu()
    {
        ...
        $dapodik_ibu = DapodikIbu::where('user_id', Auth::user()->id)->first();
        if ($dapodik_ibu != null) {
            return redirect()->route('dashboard.smp.student.dapodik.index')->with('error', 'Data Siswa - Data Ibu Sudah Diisi');
        }
    ...
    public function dapodikIbuStore(DapodikIbuRequest $request)
    {
        ...
        return redirect()->route('dashboard.smp.student.dapodik.index')->with('success', 'Data Siswa - Data Ibu Berhasil Ditambah');
    }
    ...
    public function dapodikWali()
    {
        ...
        if ($dapodik_wali != null) {
            return redirect()->route('dashboard.smp.student.dapodik.index')->with('error', 'Data Siswa - Data Wali Sudah Diisi');
        }
    ...
    public function dapodikWaliStore(DapodikWaliRequest $request)
    {
        ...
        return redirect()->route('dashboard.smp.student.dapodik.index')->with('success', 'Data Siswa - Data Wali Berhasil Ditambah');
    }
